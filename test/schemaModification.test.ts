...
describe('Schema sections can be modified in memory', () => {
    ...
    it('Modified schema gets correct results', async () => {
        ...
        await updateSettings("schemas", {
            "https://gist.githubusercontent.com/JPinkney/00b908178a64d3a6274e2c9523b39521/raw/53042c011c089b13ef0a42b4b037ea2431bbba8d/basic_completion_schema.json": "enum_completion.yaml"
        });
        ...
        await vscode.commands.executeCommand(Commands.YAML_SCHEMA_MODIFY, {
			...
			schema: 'https://gist.githubusercontent.com/JPinkney/00b908178a64d3a6274e2c9523b39521/raw/53042c011c089b13ef0a42b4b037ea2431bbba8d/basic_completion_schema.json'
        });
    ...
    it('Deleted schema gets correct results', async () => {
        ...
        // Insert the original schema
        await updateSettings("schemas", {
            "https://gist.githubusercontent.com/JPinkney/ee1caa73523b8e0574b9e9b241e2991e/raw/9569ef35a76ce5165b3c1b35abe878c44e861b33/sample.json": "enum_completion.yaml"
        });
